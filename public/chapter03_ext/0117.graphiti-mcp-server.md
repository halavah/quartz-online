---
title: "Graphiti MCP Server - AI知识图谱服务器"
description: "Graphiti MCP Server 是一个强大的AI代理知识图谱服务器，使用Neo4j构建，与模型上下文协议(MCP)集成，提供智能知识管理和检索功能"
publishDate: "2025-12-22"
tags: ["graphiti", "mcp-server", "知识图谱", "neo4j", "ai代理", "知识管理"]
draft: false
