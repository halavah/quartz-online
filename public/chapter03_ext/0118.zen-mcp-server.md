---
title: "Zen MCP Server - 多模型协调指挥系统"
description: "Zen MCP Server 是BeehiveInnovations开发的MCP服务器，让Claude作为指挥员协调调用o3、gemini2.5pro、flash等模型，发挥各自优势"
publishDate: "2025-12-22"
tags: ["zen-mcp-server", "mcp-server", "多模型协调", "指挥系统", "beebeinnovations", "模型编排"]
draft: false
