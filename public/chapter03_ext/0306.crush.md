---
title: "Crush - 终端AI编程代理工具"
description: "Crush 是Charm公司开发的终端AI编程代理，支持多AI提供商路由、自定义API端点、OpenRouter集成，提供强大的代码生成和编程辅助功能"
publishDate: "2025-12-22"
tags: ["crush", "charmbracelet", "ai编程", "终端工具", "api路由", "代码生成"]
draft: false
