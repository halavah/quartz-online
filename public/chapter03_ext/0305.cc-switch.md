---
title: "CC-Switch - Claude Code与Codex配置切换神器"
description: "CC-Switch 是一款桌面应用，专为Claude Code和Codex设计，提供可视化配置管理、多设备同步、一键切换等功能，让AI编程助手配置更简单"
publishDate: "2025-12-22"
tags: ["cc-switch", "claude-code", "codex", "配置管理", "桌面应用", "多设备同步"]
draft: false
