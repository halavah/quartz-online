---
title: "Claude Code Viewer - Web可视化客户端"
description: "Claude Code Viewer 是d-kimuson开发的Web可视化客户端，将Claude Code的终端日志转换为可视化界面，支持会话管理、Git差异查看、文件预览等功能"
publishDate: "2025-12-22"
tags: ["claude-code-viewer", "web客户端", "可视化", "会话管理", "git集成", "d-kimuson"]
draft: false
