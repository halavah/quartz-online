---
title: "Open CoreUI - Rust重写的轻量级Open WebUI"
description: "Open CoreUI 是使用Rust重写的轻量级Open WebUI服务端和桌面客户端，显著减少内存和资源占用，无需Docker和依赖服务"
publishDate: "2025-12-22"
tags: ["open-coreui", "rust", "webui", "tauri", "轻量级", "桌面应用"]
draft: false
